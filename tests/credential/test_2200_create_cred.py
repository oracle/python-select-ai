...
class TestCreateCredential:
    ...
    def drop_credential_cursor(cursor, cred_name="GENAI_CRED"):
        ...
        cursor.callproc(
            ...
            keyword_parameters={"credential_name": cred_name},
        )
    ...
    @classmethod
    def drop_local_user(cls, test_username):
        with oracledb.connect(
            **cls.test_env.connect_params(admin=True)
        ) as conn:
            with conn.cursor() as admin_cursor:
    ...
    def test_2202(self):
        ...
        try:
            ...
            pytest.fail(f"create_credential() raised {e} unexpectedly.")
        self.logger.info(
            "Attempting to create credential again (expected to fail)..."
        )
    ...
    def test_2204(self):
        ...
        try:
            select_ai.create_credential(credential=credential, replace=True)
            self.logger.info(
                "Credential created successfully with replace=True."
            )
        except Exception as e:
            pytest.fail(f"create_credential() raised {e} unexpectedly.")
        with select_ai.cursor() as cursor:
    ...
    def test_2205(self):
        ...
        assert (
            True
        ), "Credential creation and replacement passed without exception."
        with select_ai.cursor() as cursor:
            self.drop_credential_cursor(cursor)
    ...
    def test_2206(self):
        ...
        try:
            ...
            pytest.fail(f"create_credential() raised {e} unexpectedly.")
        self.logger.info(
            "Second creation without replace (expected to fail)..."
        )
        with pytest.raises(oracledb.DatabaseError) as cm:
            select_ai.create_credential(credential=credential)
    ...
    def test_2207(self):
        ...
        try:
            select_ai.create_credential(credential=credential, replace=True)
            self.logger.info(
                "Credential replaced successfully (replace=True)."
            )
        except Exception as e:
            pytest.fail(f"create_credential() raised {e} unexpectedly.")
        assert (
    ...
    def test_2208(self):
        ...
        credential = self.get_native_cred_param(
            self.credential_params, "GENAI_CRED"
        )
        try:
            select_ai.create_credential(credential=credential, replace=False)
    ...
    def test_2211(self):
        ...
        for i in range(2):
            self.logger.info(
                f"Creating native credential iteration {i+1} (replace=True)..."
            )
            select_ai.create_credential(credential=credential, replace=True)
    ...
    def test_2214(self):
        ...
        select_ai.create_credential(credential=credential, replace=True)
        self.logger.info(
            "Credential with invalid username created successfully."
        )
        with select_ai.cursor() as cursor:
            self.drop_credential_cursor(cursor)
    ...
    def test_2215(self):
        ...
        select_ai.create_credential(credential=credential, replace=True)
        self.logger.info(
            "Credential with invalid password created successfully."
        )
        with select_ai.cursor() as cursor:
            self.drop_credential_cursor(cursor)
    ...
    def test_2217(self):
        ...
        try:
            ...
            self.logger.info(
                f"Test user '{test_username}' dropped successfully."
            )
    ...
    def test_2218(self):
        ...
        with pytest.raises(
            oracledb.DatabaseError, match="ORA-20010: Invalid credential name"
        ):
            select_ai.create_credential(credential=credential, replace=False)
