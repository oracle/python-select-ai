...
class TestDropCredential:
    ...
    def test_2303(self):
        ...
        with pytest.raises(oracledb.DatabaseError) as cm:
            select_ai.delete_credential("GENAI_CRED", force=False)
        logger.info(
            f"Expected DatabaseError for second delete (force=False): {cm.value}"
        )
    ...
    def test_2304(self):
        ...
        logger.info(
            f"Expected DatabaseError for nonexistent credential: {cm.value}"
        )
    ...
    def test_2306(self):
        ...
        try:
            ...
            pytest.fail(
                f"delete_credential(force=True) raised {e} unexpectedly."
            )
    ...
    def test_2308(self):
        ...
        with pytest.raises(
            oracledb.DatabaseError, match=r"ORA-20010: Invalid credential name"
        ):
    ...
    def test_2309(self):
        ...
        try:
            with pytest.raises(
                ...
                select_ai.delete_credential("GENAI_CRED", force=True)
            logger.info(
                f"Expected DatabaseNotConnectedError raised: {cm.value}"
            )
        finally:
    ...
    def test_2311(self):
        ...
        try:
            ...
            pytest.fail(
                f"async_delete_credential raised {e} unexpectedly for lowercase name"
            )
    ...
    def test_2312(self):
        ...
        with pytest.raises(
            oracledb.DatabaseError, match=r"ORA-20010: Missing credential name"
        ):
