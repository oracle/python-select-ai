...
import pytest
import select_ai
from select_ai import OracleVectorIndexAttributes, VectorIndex
...
class TestGetVectorIndexAttributes:
    ...
    def delete_credential(cls):
        ...
        try:
            ...
            logger.info("Deleted credential self.objstore_cred")
        except Exception as e:
            logger.warning(f"delete_credential() raised {e} unexpectedly.")
    ...
    def setup_method(self, method):
        ...
        vecidx = VectorIndex()
        self.vector_index = (
            list(vecidx.list(index_name_pattern=self.index_name))
        )[0]
    ...
    def test_5306(self):
        ...
        vecidx = VectorIndex()
        vector_index = (
            list(vecidx.list(index_name_pattern=self.index_name.lower()))
        )[0]
    ...
    def test_5310(self):
        ...
        logger.info(
            "Testing access to attributes object after deleting the vector index..."
        )
        vector_index_attributes = OracleVectorIndexAttributes(
            location=self.embedding_location,
            object_storage_credential_name=self.objstore_cred,
    ...
    def test_5318(self):
        ...
        logger.info(
            "Testing get_attributes() after disconnecting from database..."
        )
