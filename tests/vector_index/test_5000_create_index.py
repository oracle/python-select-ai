...
@pytest.fixture(scope="class", autouse=True)
def setup_and_teardown(request, connect, vector_index_params):
    """
    ...
    p = request.cls.vector_index_params
...
class TestCreateVectorIndex:
    ...
    def teardown_method(self, method):
        ...
        try:
            vector_index = select_ai.VectorIndex(index_name=self.index_name)
    ...
    def test_5001(self):
        ...
        try:
            ...
            pytest.fail(
                f"VectorIndex.create raised an unexpected exception: {e}"
            )
        ...
        assert self.index_name.upper() in indexes
