...
class TestDisableProvider:
    ...
    def test_2509(self):
        ...
        try:
            ...
            logger.info("revoke_http_access() succeeded with empty users list.")
        except Exception as e:
            pytest.fail(f"revoke_http_access() raised {e} unexpectedly with empty users list.")
    ...
    def test_2511(self):
        ...
        try:
            ...
            logger.info("revoke_http_access() succeeded with lowercase username.")
        except Exception as e:
            pytest.fail(f"revoke_http_access() raised {e} unexpectedly with lowercase username.")
    ...
    def test_2516(self):
        ...
        logger.info("Testing revoke_http_access() across supported provider endpoints")
