...
class TestEnableProvider:
    ...
    def test_2401(self):
        ...
        logger.info("Testing grant_http_access() with valid users and valid endpoint")
        try:
            ...
            logger.error(f"grant_http_access() raised {e} unexpectedly.")
            pytest.fail(f"grant_http_access() raised {e} unexpectedly.")

    def test_2402(self):
        "Test enabling provider with a non-existent username"
        logger.info("Testing grant_http_access() with a mix of existing and non-existent usernames")
        db_users = ["DB_USER1", "TEST_USER2"]
        with pytest.raises(oracledb.DatabaseError, match=r"ORA-46238") as cm:
            select_ai.grant_http_access(
                users=db_users,
                provider_endpoint=self.provider_endpoint
            )
        logger.info(f"Expected DatabaseError caught: {cm.value}")
        assert "TEST_USER2" in str(cm.value)
        logger.info("Test for non-existent username completed.")

    def test_2403(self):
        "Test enabling provider with all non-existent usernames"
        logger.info("Testing grant_http_access() with all non-existent usernames")
    ...
    def test_2404(self):
        ...
        try:
            ...
            logger.error(f"grant_http_access() raised {e} unexpectedly with empty users.")
            pytest.fail(f"grant_http_access() raised {e} unexpectedly with empty users.")

    def test_2405(self):
        "Test enabling provider with users as string instead of list"
        logger.info("Testing grant_http_access() with users as a string (should be list; verify no TypeError is raised)")
        try:
            select_ai.grant_http_access(
            ...
            pytest.fail(f"grant_http_access() raised unexpected exception: {e}")

    def test_2406(self):
        "Test enabling provider with users as int - expect TypeError"
        logger.info("Testing grant_http_access() with users as an integer (type error expected)")
    ...
    def test_2407(self):
        ...
        logger.info("Testing grant_http_access() with None as provider_endpoint")
        with pytest.raises(oracledb.DatabaseError, match=r"ORA-29261") as cm:
            select_ai.grant_http_access(
                users=self.db_users,
    ...
    def test_2408(self):
        ...
        logger.info("Testing grant_http_access() with a custom host name")
        try:
            select_ai.grant_http_access(
                users=self.db_users,
            ...
            logger.error(f"grant_http_access() raised {e} unexpectedly with custom host name.")
            pytest.fail(f"grant_http_access() raised {e} unexpectedly with custom host name.")

    def test_2409(self):
        "Test enabling provider with duplicate usernames"
        logger.info("Testing grant_http_access() with duplicate usernames")
        try:
            select_ai.grant_http_access(
            ...
            logger.error(f"grant_http_access() raised {e} unexpectedly with duplicate users.")
            pytest.fail(f"grant_http_access() raised {e} unexpectedly with duplicate users.")

    def test_2410(self):
        "Test enabling provider with lowercase username (case-insensitive)"
        logger.info("Testing grant_http_access() with username in lowercase (should succeed on case-insensitive DB)")
        try:
            select_ai.grant_http_access(
            ...
            logger.error(f"grant_http_access() raised {e} unexpectedly with lowercase username.")
            pytest.fail(f"grant_http_access() raised {e} unexpectedly with lowercase username.")

    def test_2411(self):
        "Test enabling provider with username containing whitespace"
        logger.info("Testing grant_http_access() with username containing leading/trailing whitespace")
        ...
        try:
            ...
            logger.error(f"grant_http_access() raised {e} unexpectedly with whitespace in username.")
            pytest.fail(f"grant_http_access() raised {e} unexpectedly with whitespace in username.")

    def test_2412(self):
        "Test enabling provider with large user list"
        logger.info("Testing grant_http_access() with a very large list of users (DatabaseError expected)")
    ...
    def test_2413(self):
        ...
        logger.info("Testing grant_http_access() with a custom endpoint (ORA-24244 expected)")
        with pytest.raises(oracledb.DatabaseError) as cm:
            select_ai.grant_http_access(
                users=self.db_users,
    ...
    def test_2414(self):
        ...
        logger.info("Testing grant_http_access() across supported provider endpoints")
